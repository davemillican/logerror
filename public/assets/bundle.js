...
},{"jquery":31,"underscore":47}],4:[function(require,module,exports){
...
},{"./transport":17,"./transports":18,"component-emitter":9,"debug":12,"engine.io-parser":24,"indexof":29,"parsejson":33,"parseqs":34,"parseuri":35}],17:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"./keys":25,"after":1,"arraybuffer.slice":2,"base64-arraybuffer":5,"blob":6,"has-binary":26,"utf8":48}],25:[function(require,module,exports){
...
},{"./on":38,"./socket":39,"backo2":4,"component-bind":8,"component-emitter":41,"debug":12,"engine.io-client":14,"indexof":29,"socket.io-parser":43}],38:[function(require,module,exports){
...
},{"./on":38,"component-bind":8,"component-emitter":41,"debug":12,"has-binary":27,"socket.io-parser":43,"to-array":46}],40:[function(require,module,exports){
(function (global){
...
},{"./binary":42,"./is-buffer":44,"component-emitter":9,"debug":12,"isarray":30,"json3":45}],44:[function(require,module,exports){
(function (global){
...
},{"../ListView/ListView":60,"backbone":3,"underscore":47}],51:[function(require,module,exports){
'use strict';
...
},{"../AppError/AppErrorView":50,"../Collections/AppErrCollection":53,"../Collections/ErrorModel":54,"../Collections/UserErrCollection":55,"../DashboardView/DashboardView":56,"../DetailView/DetailView":58,"../ListView/ListView.js":60,"../UserError/UserErrorView":63,"../dispatcher/dispatcher":67,"backbone":3}],52:[function(require,module,exports){
'use strict';
...
},{"../DetailView/DetailView":58,"../ListView/ListView":60,"../Nav/NavView":62,"../d3/GraphView":65,"../dispatcher/dispatcher":67,"backbone":3,"jquery":31,"underscore":47}],53:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');

var AppErrCollection = Backbone.Collection.extend({});

module.exports = new AppErrCollection();
...
},{"backbone":3}],55:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');

var UserErrCollection = Backbone.Collection.extend({});

module.exports = new UserErrCollection();
...
},{"../DetailView/DetailView":58,"../ListView/ListView":60,"../d3/GraphView":65,"backbone":3,"jquery":31,"underscore":47}],57:[function(require,module,exports){
module.exports = "<div class='detail-dock'>\n    <div>\n       <span><%= date %></span> \n       <span><%= time %></span>    \n       <h4>Message: <%= msg %></h4> \n    </div> \n\n    <div> \n        <h3> Users </h3> \n        <h3> CALL STACK </h3> \n        <p><%= stack %></p> \n</div>";
...
},{"../dispatcher/dispatcher":67,"./DetailView.html":57,"backbone":3,"jquery":31,"underscore":47}],59:[function(require,module,exports){
'use strict';
...
},{"../dispatcher/dispatcher":67,"backbone":3,"jquery":31,"underscore":47}],60:[function(require,module,exports){
'use strict';
...
},{"./ListItemView":59,"./list.html":61,"backbone":3,"jquery":31,"underscore":47}],61:[function(require,module,exports){
...
var NavView = Backbone.View.extend({
    ...
    onUserErrors: function onUserErrors() {
        window.location.hash = '/userErrors';
    },

    onAppErrors: function onAppErrors() {
...
},{"backbone":3,"underscore":47}],63:[function(require,module,exports){
'use strict';
...
},{"../ListView/ListView":60,"backbone":3,"underscore":47}],64:[function(require,module,exports){
module.exports = "<button>Throw An Error</button>\n<h2 class=\"dark\">Recent Errors</h2>\n<div id='line-graph'></div>\n<div class=pie-wrapper>\n    <div class='pie-title'>\n        <h3 class=\"dark\">Historic Errors</h3>\n    </div>\n    <div id='pie-chart'></div>\n</div>\n<div class='pie-stats'>\n    <p>User Errors: <span class=userErrs></span></p>\n    <p>App Errors: <span class=appErrs></span></p>\n</div>\n<div class='cf'></div>";
...
},{"../Collections/AppErrCollection":53,"../Collections/UserErrCollection":55,"../dispatcher/dispatcher":67,"./GraphView.html":64,"./d3utils":66,"backbone":3,"jquery":31,"underscore":47}],66:[function(require,module,exports){
'use strict';
...
function graphInitialize(node) {
    ...
    function resize() {
        var w = node.parentElement ? node.parentElement.getBoundingClientRect().width : d3Node.style('width');
    ...
    svg = d3Node.append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

    clipPath = svg.append("defs").append("clipPath").attr("id", "clip").append("rect").attr("width", width).attr("height", height);

    xAxis = svg.append("g").attr("class", "x axis").attr("transform", "translate(0," + y(0) + ")").call(d3.svg.axis().scale(x).orient("bottom"));
    ...
    function tick() {
        ...
        path.attr("d", line).attr("transform", null).transition().duration(200).ease("linear").attr("transform", "translate(" + x(0) + ",0)").each("end", tick);
...
function pieChart() {
    ...
    var pieData = [{ "label": "user", "value": errorCount.userErrors }, { "label": "app", "value": errorCount.appErrors }];

    $('#pie-chart').html('');

    var vis = d3.select('#pie-chart').append("svg:svg").data([pieData]).attr("width", w).attr("height", h).append("svg:g").attr("transform", "translate(" + r + "," + r + ")");
...
},{"d3":11,"jquery":31}],67:[function(require,module,exports){
'use strict';
...
},{"backbone":3,"underscore":47}],68:[function(require,module,exports){
'use strict';
...
},{"./components/AppRouter/AppRouter":51,"./components/AppView/AppView":52,"./components/Collections/AppErrCollection":53,"./components/Collections/UserErrCollection":55,"./components/d3/d3utils":66,"./components/dispatcher/dispatcher":67,"backbone":3,"jquery":31,"socket.io-client":36}]},{},[68]);
